...
clearvars
clear global
filePrefix = 'DCPP01C'; % File name to match. 
...
LTSApath = 'E:\bigDL\DCPP01C'; % directory containing all LTSAs for this deployment
% LTSA folder should match the site specified in prefix
tpwsPath ='E:\bigDL\DCPP01C'; %directory of TPWS files
