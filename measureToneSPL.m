...
inDir = '/Users/rec297/Documents/CCB/WRI_2024/20240613_DriftTest/FilesWTones';
outDir = '/Users/rec297/Documents/CCB/WRI_2024/20240613_DriftTest/FilesWTones';
BD = 16; % bit depth
toneStart = [1438.95];
toneDur = 0.2; % s
clipDur = 0.1; % s
freqs = [150,300,1000,2000,3000];
gap = 1.06; % s between playback iterations
refPres = 1e-6; % reference pressure for SPL measurements (1 muPa for underwater, 20 muPa for in air)
cal = 176.6;
cal_lin = power(10, cal / 20);
