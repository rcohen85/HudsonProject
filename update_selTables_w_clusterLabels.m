...
labDir = 'W:\projects\2022_NOAA-NERRS_HudsonNY_144488\ShortStur\Clusters\compositeClusters_combined\Pr95_Trans\TPWS_labels'; 
% directory containing selection tables to be updated
selTableDir = 'W:\projects\2022_NOAA-NERRS_HudsonNY_144488\ShortStur\SelectionTables\Combined\Unlabeled'; 
% directory to save updated selection tables; if empty, tables in selTableDir will be overwritten
outDir = 'W:\projects\2022_NOAA-NERRS_HudsonNY_144488\ShortStur\SelectionTables\Combined\IT03'; 
% label file name wildcard
labID = '*ID1.mat';
% end date of deployment
depEnd = '2022-10-30 00:00:00'; 
